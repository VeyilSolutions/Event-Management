...
const GALLERY_DATA = {
  photography: [
    ...
    { id: 'ev-img-4', type: 'image', tag: 'Logistics', title: 'Crowd Flow', desc: 'Efficient management for 5000+ attendees.', url: 'https://images.unsplash.com/photo-1651313533623-e8fe0c1ee06e?q=80&w=774&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3Dnsplash.com/premium_photo-1664790560022-324e031a6352?q=80&w=387&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', span: 'md:col-span-1 md:row-span-1' },
    ...
    { id: 'ev-img-6', type: 'image', tag: 'VIP', title: 'Artist Lounge', desc: 'Exclusive backstage hospitality setup.', url: 'https://plus.unsplash.com/premium_photo-1664790560022-324e031a6352?q=80&w=387&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', span: 'md:col-span-2 md:row-span-1' },
  ],
  cinematography: [
    ...
    { id: 'ev-vid-2', type: 'video', tag: 'BTS', title: 'The Making Of', desc: 'Behind the scenes: From empty hall to grand opening.', videoId: 'rrOQ8F4oDBDmaQ2l', span: 'md:col-span-2 md:row-span-1' },
